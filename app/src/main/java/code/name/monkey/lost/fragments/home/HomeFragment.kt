package code.name.monkey.lost.fragments.home
...
import code.name.monkey.lost.adapter.HomeAdapter
import code.name.monkey.lost.databinding.FragmentHomeBinding
import code.name.monkey.lost.dialogs.CreatePlaylistDialog
import code.name.monkey.lost.dialogs.ImportPlaylistDialog
import code.name.monkey.lost.extensions.accentColor
import code.name.monkey.lost.extensions.dip
import code.name.monkey.lost.extensions.elevatedAccentColor
import code.name.monkey.lost.extensions.setUpMediaRouteButton
import code.name.monkey.lost.fragments.ReloadType
import code.name.monkey.lost.fragments.base.AbsMainActivityFragment
import code.name.monkey.lost.glide.LostGlideExtension
import code.name.monkey.lost.glide.LostGlideExtension.profileBannerOptions
import code.name.monkey.lost.glide.LostGlideExtension.songCoverOptions
import code.name.monkey.lost.glide.LostGlideExtension.userProfileOptions
...
import code.name.monkey.lost.util.PreferenceUtil.userName
...
class HomeFragment :
    ...
    private fun setupTitle() {
        ...
        val appName = "Lost <font color=$hexColor>Music</font>".parseAsHtml()
    ...
    private fun loadProfile() {
        binding.bannerImage?.let {
            Glide.with(requireContext())
                .load(LostGlideExtension.getBannerModel())
                .profileBannerOptions(LostGlideExtension.getBannerModel())
                .into(it)
        }
        Glide.with(requireActivity())
            .load(LostGlideExtension.getUserModel())
            .userProfileOptions(LostGlideExtension.getUserModel(), requireContext())
    ...
    private fun loadSuggestions(songs: List<Song>) {
        ...
        images.forEachIndexed { index, imageView ->
            ...
            Glide.with(this)
                .load(LostGlideExtension.getSongModel(songs[index]))
