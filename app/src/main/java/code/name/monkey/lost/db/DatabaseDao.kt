...
import code.name.monkey.lost.contants.AlbumSortType
import code.name.monkey.lost.contants.ArtistSongSortType
import code.name.monkey.lost.contants.ArtistSortType
import code.name.monkey.lost.contants.PlaylistSortType
import code.name.monkey.lost.contants.SongSortType
import code.name.monkey.lost.db.entities.Album
...
import code.name.monkey.lost.db.entities.AlbumWithSongs
import code.name.monkey.lost.db.entities.Artist
import code.name.monkey.lost.db.entities.ArtistEntity
import code.name.monkey.lost.db.entities.Event
import code.name.monkey.lost.db.entities.EventWithSong
import code.name.monkey.lost.db.entities.FormatEntity
import code.name.monkey.lost.db.entities.LyricsEntity
import code.name.monkey.lost.db.entities.Playlist2
...
import code.name.monkey.lost.db.entities.SongWithStats
import code.name.monkey.lost.extensions.toSQLiteQuery
import code.name.monkey.lost.model.MediaMetadata
import code.name.monkey.lost.model.toMediaMetadata
...
import code.name.monkey.lost.extensions.reversed
...
interface DatabaseDao {
    ...
    fun playlistsByCreateDateAsc(): Flow<List<Playlist2>>
    ...
    fun playlistsByUpdatedDateAsc(): Flow<List<Playlist2>>
    ...
    fun playlistsByNameAsc(): Flow<List<Playlist2>>
    ...
    fun playlistsBySongCountAsc(): Flow<List<Playlist2>>
    ...
    fun playlist(playlistId: String): Flow<Playlist2?>
    ...
    fun editablePlaylistsByCreateDateAsc(): Flow<List<Playlist2>>
    ...
    fun playlistByBrowseId(browseId: String): Flow<Playlist2?>
    ...
    @Transaction
    fun addSongToPlaylist(playlist: Playlist2, songIds: List<String>) {
    ...
    @Insert(onConflict = OnConflictStrategy.IGNORE)
    fun insert(playlist: PlaylistEntity2)
    ...
    @Update
    fun update(playlist: PlaylistEntity2)
    ...
    @Update
    fun update(PlaylistEntity2: PlaylistEntity2, playlistItem: PlaylistItem) {
        update(
            PlaylistEntity2.copy(
    ...
    @Delete
    fun delete(playlist: PlaylistEntity2)
