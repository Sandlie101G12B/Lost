package code.name.monkey.lost.fragments.library
...
import code.name.monkey.lost.databinding.FragmentLibraryBinding
...
class LibraryFragment : AbsMainActivityFragment(R.layout.fragment_library) {
    ...
    private fun setupTitle() {
        ...
        val appName = "Lost <span  style='color:$hexColor';>Music</span>".parseAsHtml()
