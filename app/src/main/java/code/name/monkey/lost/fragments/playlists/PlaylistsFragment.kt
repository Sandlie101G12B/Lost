...
import code.name.monkey.lost.EXTRA_PLAYLIST_ID
import code.name.monkey.lost.R
import code.name.monkey.lost.adapter.playlist.PlaylistAdapter
...
import code.name.monkey.lost.fragments.base.AbsRecyclerViewCustomGridSizeFragment
import code.name.monkey.lost.helper.SortOrder.PlaylistSortOrder
import code.name.monkey.lost.interfaces.IPlaylistClickListener
...
class PlaylistsFragment :
    ...
    private fun setupGridSizeMenu(gridSizeMenu: SubMenu) {
        ...
        val gridSize = if (LostUtil.isLandscape) 4 else 3
        if (gridSize < 8) {
