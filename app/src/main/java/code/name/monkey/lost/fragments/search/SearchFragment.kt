package code.name.monkey.lost.fragments.search
...
import code.name.monkey.lost.adapter.SearchAdapter
import code.name.monkey.lost.databinding.FragmentSearchBinding
