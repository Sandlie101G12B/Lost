package code.name.monkey.lost.glide.artistimage

import android.content.Context
import code.name.monkey.lost.model.Data
import code.name.monkey.lost.model.DeezerResponse
import code.name.monkey.lost.network.DeezerService
