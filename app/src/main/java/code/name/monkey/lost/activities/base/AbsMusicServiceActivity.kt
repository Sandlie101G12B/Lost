...
import code.name.monkey.lost.db.toPlayCount
import code.name.monkey.lost.helper.MusicPlayerRemote
import code.name.monkey.lost.interfaces.IMusicServiceEventListener
import code.name.monkey.lost.repository.RealRepository
import code.name.monkey.lost.service.MusicService.Companion.FAVORITE_STATE_CHANGED
import code.name.monkey.lost.service.MusicService.Companion.MEDIA_STORE_CHANGED
import code.name.monkey.lost.service.MusicService.Companion.META_CHANGED
import code.name.monkey.lost.service.MusicService.Companion.PLAY_STATE_CHANGED
import code.name.monkey.lost.service.MusicService.Companion.QUEUE_CHANGED
import code.name.monkey.lost.service.MusicService.Companion.REPEAT_MODE_CHANGED
import code.name.monkey.lost.service.MusicService.Companion.SHUFFLE_MODE_CHANGED
    ...
    override fun onPlayingMetaChanged() {
        ...
        lifecycleScope.launch(Dispatchers.IO) {
            if (!PreferenceUtil.pauseHistory) {
                ...
                println("player history 3: ${song.title}, ${song.data}")
