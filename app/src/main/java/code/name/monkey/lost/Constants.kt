...
object Constants {
    ...
    const val RATE_ON_GOOGLE_PLAY =
        "https://play.google.com/store/apps/details?id=code.name.monkey.lost"
    const val TRANSLATE = "https://crowdin.com/project/lost"
    const val WEBSITE = "https://lost.app"
    const val GITHUB_PROJECT = "https://github.com/Lost/Lost"
    const val TELEGRAM_CHANGE_LOG = "https://t.me/lostlog"
    const val USER_PROFILE = "profile.jpg"
    const val USER_BANNER = "banner.jpg"
    const val APP_TELEGRAM_LINK = "https://t.me/lostapp/"
