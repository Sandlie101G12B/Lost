package code.name.monkey.lost.fragments.albums
...
import code.name.monkey.lost.EXTRA_ARTIST_NAME
import code.name.monkey.lost.R
import code.name.monkey.lost.activities.tageditor.AbsTagEditorActivity
import code.name.monkey.lost.activities.tageditor.AlbumTagEditorActivity
import code.name.monkey.lost.adapter.album.HorizontalAlbumAdapter
import code.name.monkey.lost.adapter.song.SimpleSongAdapter
import code.name.monkey.lost.databinding.FragmentAlbumDetailsBinding
import code.name.monkey.lost.dialogs.AddToPlaylistDialog
import code.name.monkey.lost.dialogs.DeleteSongsDialog
...
import code.name.monkey.lost.glide.SingleColorTarget
import code.name.monkey.lost.helper.MusicPlayerRemote
import code.name.monkey.lost.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_A_Z
import code.name.monkey.lost.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_DURATION
import code.name.monkey.lost.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_TRACK_LIST
import code.name.monkey.lost.helper.SortOrder.AlbumSongSortOrder.Companion.SONG_Z_A
...
import code.name.monkey.lost.util.*
...
class AlbumDetailsFragment : AbsMainActivityFragment(R.layout.fragment_album_details),
        ...
        if (lastFmAlbum.album != null) {
            ...
            if (lastFmAlbum.album.listeners.isNotEmpty()) {
                ...
                binding.fragmentAlbumContent.listeners.text =
                    LostUtil.formatValue(lastFmAlbum.album.listeners.toFloat())
                binding.fragmentAlbumContent.scrobbles.text =
                    LostUtil.formatValue(lastFmAlbum.album.playcount.toFloat())
            }
        }
    }
    ...
    private fun loadArtistImage(artist: Artist) {
        ...
        Glide.with(requireContext())
            ...
            .load(
                LostGlideExtension.getArtistModel(
                    artist,
