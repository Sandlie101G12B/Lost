...
import code.name.monkey.lost.databinding.FragmentWhatsNewBinding
import code.name.monkey.lost.extensions.accentColor
import code.name.monkey.lost.extensions.openUrl
import code.name.monkey.lost.util.PreferenceUtil.lastVersion
...
class WhatsNewFragment : BottomSheetDialogFragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        try {
            ...
            val stream = requireContext().assets.open("lost-changelog.html")
