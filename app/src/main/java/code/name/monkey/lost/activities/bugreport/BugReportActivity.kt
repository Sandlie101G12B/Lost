package code.name.monkey.lost.activities.bugreport
...
import code.name.monkey.lost.activities.bugreport.model.DeviceInfo
import code.name.monkey.lost.databinding.ActivityBugReportBinding
...
open class BugReportActivity : AbsThemeActivity() {
    ...
    companion object {
        private const val ISSUE_TRACKER_LINK =
            "https://github.com/Lost/Lost/issues"
    }
}
