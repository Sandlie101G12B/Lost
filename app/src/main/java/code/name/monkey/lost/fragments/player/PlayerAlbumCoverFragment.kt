package code.name.monkey.lost.fragments.player
...
import code.name.monkey.lost.LYRICS_TYPE
import code.name.monkey.lost.R
import code.name.monkey.lost.SHOW_LYRICS
import code.name.monkey.lost.adapter.album.AlbumCoverPagerAdapter
import code.name.monkey.lost.adapter.album.AlbumCoverPagerAdapter.AlbumCoverFragment
import code.name.monkey.lost.databinding.FragmentPlayerAlbumCoverBinding
...
import code.name.monkey.lost.fragments.base.goToLyrics
import code.name.monkey.lost.helper.MusicPlayerRemote
import code.name.monkey.lost.helper.MusicProgressViewUpdateHelper
import code.name.monkey.lost.lyrics.CoverLrcView
import code.name.monkey.lost.model.lyrics.Lyrics
import code.name.monkey.lost.transform.CarousalPagerTransformer
import code.name.monkey.lost.transform.ParallaxPagerTransformer
import code.name.monkey.lost.util.CoverLyricsType
