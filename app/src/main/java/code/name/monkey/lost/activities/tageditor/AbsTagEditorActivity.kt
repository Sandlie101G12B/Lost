...
import code.name.monkey.lost.R.drawable
import code.name.monkey.lost.activities.base.AbsBaseActivity
import code.name.monkey.lost.extensions.accentColor
import code.name.monkey.lost.extensions.colorButtons
import code.name.monkey.lost.extensions.hideSoftKeyboard
