package code.name.monkey.lost.fragments.player.classic
...
import code.name.monkey.lost.adapter.song.PlayingQueueAdapter
import code.name.monkey.lost.databinding.FragmentClassicPlayerBinding
import code.name.monkey.lost.extensions.*
import code.name.monkey.lost.fragments.MusicSeekSkipTouchListener
import code.name.monkey.lost.fragments.base.AbsPlayerControlsFragment
import code.name.monkey.lost.fragments.base.AbsPlayerFragment
import code.name.monkey.lost.fragments.base.goToAlbum
import code.name.monkey.lost.fragments.base.goToArtist
import code.name.monkey.lost.fragments.other.VolumeFragment
...
import code.name.monkey.lost.misc.SimpleOnSeekbarChangeListener
