...
import code.name.monkey.lost.BLUETOOTH_PLAYBACK
import code.name.monkey.lost.EQUALIZER
import code.name.monkey.lost.R
import code.name.monkey.lost.activities.base.AbsBaseActivity.Companion.BLUETOOTH_PERMISSION_REQUEST
