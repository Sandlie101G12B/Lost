...
import code.name.monkey.lost.service.MusicService.Companion.ACTION_PAUSE
import code.name.monkey.lost.service.MusicService.Companion.ACTION_PLAY
        ...
        private fun acquireWakeLockAndSendMessage(context: Context, msg: Message, delay: Long) {
            if (wakeLock == null) {
                ...
                wakeLock = pm?.newWakeLock(
                    ...
                    "LostApp:Wakelock headset button"
                )
