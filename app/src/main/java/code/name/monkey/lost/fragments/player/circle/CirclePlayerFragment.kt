package code.name.monkey.lost.fragments.player.circle
...
import code.name.monkey.lost.databinding.FragmentCirclePlayerBinding
...
import code.name.monkey.lost.glide.LostGlideExtension.simpleSongCoverOptions
import code.name.monkey.lost.glide.crossfadeListener
...
class CirclePlayerFragment : AbsPlayerFragment(R.layout.fragment_circle_player), Callback,
    ...
    private fun updateSong() {
        ...
        Glide.with(this)
            .load(LostGlideExtension.getSongModel(MusicPlayerRemote.currentSong))
