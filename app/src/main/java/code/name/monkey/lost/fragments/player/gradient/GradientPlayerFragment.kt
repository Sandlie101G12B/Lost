package code.name.monkey.lost.fragments.player.gradient
...
import code.name.monkey.lost.databinding.FragmentGradientPlayerBinding
...
import code.name.monkey.lost.fragments.player.CoverLyricsFragment
