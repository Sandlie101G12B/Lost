package code.name.monkey.lost.appshortcuts.shortcuttype
...
import code.name.monkey.lost.appshortcuts.AppShortcutIconGenerator
import code.name.monkey.lost.appshortcuts.AppShortcutLauncherActivity
