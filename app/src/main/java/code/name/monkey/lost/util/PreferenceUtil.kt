...
import code.name.monkey.lost.extensions.getIntRes
import code.name.monkey.lost.extensions.getStringOrDefault
import code.name.monkey.lost.fragments.AlbumCoverStyle
import code.name.monkey.lost.fragments.GridStyle
import code.name.monkey.lost.fragments.NowPlayingScreen
import code.name.monkey.lost.fragments.folder.FoldersFragment
import code.name.monkey.lost.helper.SortOrder.*
import code.name.monkey.lost.model.CategoryInfo
import code.name.monkey.lost.transform.*
import code.name.monkey.lost.util.theme.ThemeMode
import code.name.monkey.lost.views.TopAppBarLayout
...
object PreferenceUtil {
    ...
    fun themeResFromPrefValue(themePrefValue: String): Int {
        return when (themePrefValue) {
            ...
            "dark" -> R.style.Theme_Lost
            else -> R.style.Theme_Lost
        }
    }
