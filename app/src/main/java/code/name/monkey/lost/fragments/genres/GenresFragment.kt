package code.name.monkey.lost.fragments.genres
...
import code.name.monkey.lost.EXTRA_GENRE
import code.name.monkey.lost.R
import code.name.monkey.lost.adapter.GenreAdapter
import code.name.monkey.lost.extensions.setUpMediaRouteButton
import code.name.monkey.lost.fragments.ReloadType
import code.name.monkey.lost.fragments.base.AbsRecyclerViewFragment
...
GenresFragment : AbsRecyclerViewFragment<GenreAdapter, LinearLayoutManager>(),
    ...
    override fun createLayoutManager(): LinearLayoutManager {
        return if (LostUtil.isLandscape) {
