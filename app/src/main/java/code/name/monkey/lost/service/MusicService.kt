...
import code.name.monkey.lost.activities.LockScreenActivity
import code.name.monkey.lost.appwidgets.*
...
import code.name.monkey.lost.extensions.toMediaSessionQueue
...
import code.name.monkey.lost.providers.SongPlayCountStore
import code.name.monkey.lost.service.notification.PlayingNotification
import code.name.monkey.lost.service.notification.PlayingNotificationClassic
import code.name.monkey.lost.service.notification.PlayingNotificationImpl24
...
import code.name.monkey.lost.util.PreferenceUtil.isBluetoothSpeaker
import code.name.monkey.lost.util.PreferenceUtil.isBlurredAlbumArt
import code.name.monkey.lost.util.PreferenceUtil.isClassicNotification
import code.name.monkey.lost.util.PreferenceUtil.isHeadsetPlugged
import code.name.monkey.lost.util.PreferenceUtil.isLockScreen
import code.name.monkey.lost.util.PreferenceUtil.isPauseOnZeroVolume
...
import code.name.monkey.lost.util.PreferenceUtil.registerOnSharedPreferenceChangedListener
import code.name.monkey.lost.util.PreferenceUtil.unregisterOnSharedPreferenceChangedListener
import code.name.monkey.lost.volume.AudioVolumeObserver
...
class MusicService : MediaBrowserServiceCompat(),
    ...
    companion object {
        ...
        const val RETRO_MUSIC_PACKAGE_NAME = "code.name.monkey.lost"
